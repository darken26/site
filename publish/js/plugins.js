...
(function($) {
   ...
   $.bindIconToolTips = function(){
        ...
        var resumeContent = "You mean serious business?  Check here!";
        var blogContent = "Read my random ramblings.  Be warned, here be dragons!";
        ...
        $("#resume").attr('title', resumeContent);
        $("#blog").attr('title', blogContent);
        ...
        $("#resume").tooltip({position: 'center, right'});
        $("#blog").tooltip({position: 'center, right'});
